          ...
          <b-card-title class="text-center">
            ...
            <b-card-body>
              <b-form @submit.prevent="add_client_data">
                ...
                <b-form-group id="input-group-company-name" label="Company Name" label-for="input-company-name">
                  <b-form-input
                ...
                <b-form-group id="input-group-establishment-country-code" label="Establishment Country" label-for="input-establishment-country-code">
                  <b-form-input
