      ...
      >
        <b-collapse v-model="vatinVerified">
          <b-button
            ...
            @click="validate"
          >
            <span v-if="buttonValidateBusy"><b-spinner small /></span>
          ...
          <div v-if="vatinValidated" class="mt-3">
            <b-row>
              <b-col cols="3" md="6">
                <b-form-group>
                  <b-form-input id="valid" v-model="payloadValidString" :state="payload.valid" type="text" cols-sm="3" disabled />
                  <b-form-invalid-feedback :state="payload.valid">
                    Only valid vat numbers are accepted for seller firms.
                  </b-form-invalid-feedback>
                </b-form-group>
              </b-col>
              <b-col cols="9" md="6">
                <b-form-group description="Last Validation">
                  <b-form-input id="request_date" type="text" cols-sm="3" :value="payload.request_date" disabled />
                </b-form-group>
              </b-col>
            </b-row>
            <b-row>
