<template>
    <div>
        ...
        transactionInputs() {{ transactionInputs }} <br><br>

        <b-table :fields="fields" :items="transactionInputs" hover>
...
export default {
    ...
    computed: {
        ...mapState({
            transactionInputs: state => state.seller_firm.seller_firm.transaction_inputs,
