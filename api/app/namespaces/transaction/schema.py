...
transaction_dto = transaction_sub_dto.clone('transaction', {
    ...
    'modified_by': fields.String(attribute=lambda x: x.modifier.name if x.modifier else None, readonly=True),
    ...
    'customer_vatin': fields.Nested(vatin_sub_dto),
    'supplier_relationship': fields.String,
    'supplier_vatin': fields.Nested(vatin_sub_dto),
    ...
    'invoice_currency': fields.String(attribute=lambda x: x.invoice_currency.name if x.invoice_currency else None, readonly=True),
